...
public class OrderBookCalculator {
    ...
    public static double weightedPressure(List<DepthLevel> bids,
    ...
    public static long aggression(OrderBookSnapshot prev,
    ...
    public static double priceVelocity(OrderBookSnapshot prev,
                                       OrderBookSnapshot curr) {
    ...
    public static boolean absorption(OrderBookSnapshot prev,
                                     OrderBookSnapshot curr) {
